...
namespace ZLogger
{
    ...
    {
        [HideInCallstack, JetBrains.Annotations.StringFormatMethod("format")]
        ...
        [HideInCallstack, JetBrains.Annotations.StringFormatMethod("format"), Conditional("ALLOW_TRACE_LOGS")]
        ...
        [HideInCallstack, JetBrains.Annotations.StringFormatMethod("format"), Conditional("ALLOW_DEBUG_LOGS")]
        ...
        [HideInCallstack, JetBrains.Annotations.StringFormatMethod("message")]
